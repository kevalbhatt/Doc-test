...
`,T=j.d.code`
	...
	${P("styles.code")};
`;function $(){return($=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const H=j.d.a`
  &,
  &:visited,
  &:active {
...
`;_e.defaultProps=Le;const Re=e=>{const{item:t,sidebarToggle:o,handleActiveMenu:n,activeMenu:a}=e,i=Se.checkMenuIsOPen(e),s=i,l=!t.href&&t.menu&&t.menu.length>0,u=!t.href&&!t.route,d=e=>{e.preventDefault(),n(t)},c={handleActiveMenu:n,activeMenu:a};let p=r.createElement(ze,null,r.createElement(Ae,$e({item:t},u&&{onClick:d}),` ${t.name} `,l&&r.createElement(_e,{opened:s},r.createElement(de.a,{size:15}))),l&&r.createElement(Me,{opened:s},t.menu&&t.menu.map(e=>r.createElement(Me,{opened:s,key:e.name},r.createElement(Te,$e({item:e},c))))));return l||u||(p=r.createElement(ze,null,r.createElement(Ae,$e({item:t},i&&{handleToggle:d}),`${t.name} `))),p};Re.defaultProps={item:He,sidebarToggle:null,collapseAll:!0},Re.defaultProps={opened:!1,hasActive:!1};const Ne={opened:!0},Be=e=>e.opened?"45deg":"0deg",Fe=j.d.div`
  position: relative;
  width: 23px;
  height: 32px;
...
`,$t=j.d.ol`
  ...
  ${P("styles.ol")};
`;var Ht=o("./node_modules/react-feather/dist/icons/edit-2.js"),zt=o.n(Ht);const Lt=j.d.button`
	cursor: pointer;
	display: flex;
	align-items: center;
	outline: none;
