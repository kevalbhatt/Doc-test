...
`,I.d.input`
  ...
  font-size: 16px;
  color: ${ne};
`;var ae=o("./node_modules/react-feather/dist/icons/chevron-down.js"),re=o.n(ae);o("./node_modules/@reach/router/es/index.js");const ie=Object(S.b)("colors.sidebarPrimary"),se=Object(S.b)("colors.primary"),le={to:"",onClick:r.MouseEventHandler},de=I.d.a`
  position: relative;
  font-size: 14px;
...
`;de.defaultProps=le;Object.assign({},le,{as:null,slug:""}),I.d.div`
  display: flex;
  flex-direction: column;
  margin: 5px 0 0 24px;
`;const ce=({route:e,onClick:t})=>{const o=Object(d.h)(),{linkComponent:n}=Object(d.g)();o&&((e,t)=>{const o=t.find(t=>t.route===e),n=u()(o,"headings");n&&n.filter(e=>2===e.depth)})(e,o);return null};function ue(){return(ue=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const pe=I.c`
  padding-left: 0;
  &:after {
    width: 1px;
  }
...
`,ge=he(I.d.a``),fe=(e=null,t)=>{const o=e&&e.classList.contains("active"),n=t&&(e=>{if("undefined"!==typeof window)return location.pathname.slice(0,location.pathname.length-1)===e})(t);return Boolean(o||n)},be=(r.MouseEventHandler,r.ReactNode,r.forwardRef(({item:e,children:t,onClick:o,onActiveChange:n},a)=>{const{linkComponent:i}=Object(d.g)(),[s,l]=Object(r.useState)(!1),c=Object(d.i)(s),u=Object(r.useRef)(a),p=Object(r.useMemo)(()=>he(i),[i]),m={children:t,onClick:o};return Object(r.useEffect)(()=>{const t=fe(u.current,e.route);c!==t&&(l(t),u&&((e,t)=>{t&&t&&!e.classList.contains("active")&&e.classList.add("active")})(u.current,t),n&&n(t))}),r.createElement(me,{active:s},e.route?r.createElement(p,ue({},m,{to:e.route,innerRef:u,activeClassName:"active",partiallyActive:!0})):r.createElement(ge,ue({},m,{ref:u,href:e.href||"#",target:e.href?"_blank":"_self"},!e.href&&{onClick:e=>{e.preventDefault(),m.onClick&&m.onClick(e)}})),s&&e.route&&r.createElement(ce,{route:e.route}))}));function ve(){return(ve=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}be.displayName="MenuLink";const xe={id:"",name:"",route:"",href:"",menu:[],order:Number,parent:""},ye=I.d.div`
  display: flex;
  flex-direction: column;
...
`;we.defaultProps=ke;const Ee=I.d.div`
  position: absolute;
  top: 50%;
  right: 20px;
...
`;Ee.defaultProps=ke;const je=e=>{const[t,o]=Object(r.useState)(!0),{item:n,sidebarToggle:a,collapseAll:i}=e,s=i||t,l=!n.href&&n.submenu&&n.submenu.length>0,d=!n.href&&!n.route,c=e=>{e.preventDefault(),(()=>o(e=>!e))()};let u="";return u=(n.submenu&&n.submenu.length)>1?r.createElement(ye,null,r.createElement(be,ve({item:n},d&&{onClick:c}),`${n.name}`,l&&r.createElement(Ee,{opened:s},r.createElement(re.a,{size:15}))),l&&r.createElement(we,{opened:s},n.submenu&&n.submenu.map(e=>r.createElement("dt",{key:e.name},r.createElement(be,{item:e,onClick:a,onActiveChange:o},`${e.name}`))))):r.createElement(ye,null,n.submenu&&n.submenu.map(e=>r.createElement("dt",{key:e.name},r.createElement(be,{item:e,onActiveChange:o},`${e.name}`))))};function Ce(){return(Ce=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}je.defaultProps={item:xe,sidebarToggle:null,collapseAll:!0},je.defaultProps={opened:!0,hasActive:!0};const Ae={id:"",name:"",route:"",href:"",menu:[],order:Number,parent:""},Oe=I.d.div`
  display: flex;
  flex-direction: column;
`,Ie={opened:!1},Se=I.d.dl`
  flex: 1;
  overflow-y: auto;
  visibility: ${e=>e.opened?"visible":"hidden"};
  max-height: ${e=>e.opened?"auto":"0px"};
`;Se.defaultProps=Ie;const Pe=I.d.div`
  position: absolute;
  top: 50%;
  right: 20px;
  transform: translateY(-50%) rotate(${e=>e.opened?"-180deg":"0deg"});
...
`;Pe.defaultProps=Ie;const De=e=>{const[t,o]=Object(r.useState)(!0),{item:n,sidebarToggle:a,collapseAll:i}=e,s=i||t,l=!n.href&&n.menu&&n.menu.length>0,d=!n.href&&!n.route,c=e=>{e.preventDefault(),(()=>o(e=>!e))()};let u=r.createElement(Oe,null,r.createElement(be,Ce({item:n},d&&{onClick:c}),` ${n.name} `,l&&r.createElement(Pe,{opened:s},r.createElement(re.a,{size:15}))),l&&r.createElement(Se,{opened:s},n.menu&&n.menu.map(e=>r.createElement(Se,{opened:s,key:e.name},r.createElement(je,{item:e})))));return l||d||(u=r.createElement(Oe,null,r.createElement(be,Ce({item:n},t&&{handleToggle:c}),`${n.name} `))),u};De.defaultProps={item:Ae,sidebarToggle:null,collapseAll:!0},De.defaultProps={opened:!1,hasActive:!1};const $e={opened:!0},He=e=>e.opened?"45deg":"0deg",Te=I.d.div`
  position: relative;
  width: 23px;
  height: 32px;
...
`;Te.defaultProps=$e;const Be=Object(S.b)("colors.sidebarBg"),Le=Object(S.b)("colors.sidebarPrimary"),Fe=Object(S.b)("colors.sidebarText"),Me=Object(S.b)("colors.primary"),Re=Object(S.b)("colors.background"),ze=Object(S.b)("colors.text"),Ne=I.d.span`
  content: "";
  display: block;
  position: absolute;
  width: 100%;
  ...
  left: 0;
  right: 0;
  background: ${e=>e.opened?Fe(e):ze(e)};
  transition: transform 0.3s, opacity 0.3s;

  &:nth-of-type(1) {
    top: -2px;
    transform: translateY(${e=>e.opened?"10px":"0px"}) rotate(${He});
  }
  ...
  &:nth-of-type(3) {
    top: 14px;
    transform: translateY(${e=>e.opened?"-6px":"0px"}) rotate(-${He});
  }
`;Ne.defaultProps=$e;const _e=Object(S.b)("radii"),qe=I.d.button`
  cursor: pointer;
  z-index: 99;
  position: absolute;
  display: flex;
  ...
  outline: none;
  border: none;
  background: ${e=>e.opened?Be(e):Re(e)};
...
`;qe.defaultProps=$e;Object.assign({},$e,{onClick:e=>null});const We=({opened:e,onClick:t})=>r.createElement(qe,{opened:e,onClick:t},r.createElement(Te,{opened:e},r.createElement(Ne,{opened:e}),r.createElement(Ne,{opened:e}),r.createElement(Ne,{opened:e})));function Ue(e){return e&&"object"===typeof e&&"default"in e?e.default:e}const Ge=Ue(o("./node_modules/lodash/fp/pipe.js")),Ve=Ue(o("./node_modules/lodash/fp/omit.js")),Ze=Ue(o("./node_modules/array-sort/index.js")),Qe=Ue(o("./node_modules/lodash/fp/flattenDepth.js")),Ye=Ue(o("./node_modules/match-sorter/dist/match-sorter.esm.js")),Ke=o("./node_modules/ulid/dist/index.esm.js"),Xe=Object(S.b)("colors.sidebarBg"),Je=Object(S.b)("colors.sidebarText"),et=Object(S.b)("colors.sidebarBorder"),tt=I.d.div`
  position: relative;
  width: 320px;
  min-width: 320px;
  min-height: 100vh;
...
`,I.d.div`
  ...
  cursor: pointer;
  z-index: 99;
`);const it=(e,t)=>e.name<t.name?-1:e.name>t.name?1:0,st=(e,t=[])=>{const o="string"!==typeof e?V()("name",e):e,n=t.findIndex(e=>e===o);return-1!==n?n:1/0},lt=e=>!e.submenu,dt=e=>{const t=(e=>"string"===typeof e?{name:e}:e)(e);return Object.assign({},t,{id:t.id||Ke.ulid(),parent:V()("parent",t)||V()("parent",e),menu:Array.isArray(t.menu)?t.menu.map(dt):t.menu})},ct=Ge(dt,e=>e.href||e.route?Ve("menu",e):e),ut=e=>t=>t.submenu===e,pt=e=>({name:e.name,route:e.route,parent:e.parent,submenu:e.submenu,menu:e.menu});function mt(e,t,o){return Array.from(new Set(e.reduce((e,o)=>{const n=V()(t)(o);return n?e.concat([n]):e},[])))}const ht=(e,t)=>t.filter(ut(e)).map(pt),gt=(e,t)=>t.filter(ut(e)).map(pt),ft=e=>{const t=e.filter(lt).map(pt),o=mt(e,"menu").map((e=>t=>({name:t,menu:gt(t,e)}))(e)),n=mt(e,"submenu").map(function(e){return function(t){return{name:t,submenu:ht(t,e),menu:gt(t,e)}}}(e));for(var a in o)for(var r of t)if(r.name==o[a].name){o[a]=r;break}for(var a in o)for(var i in n)o[a].name==n[i].menu[0].menu&&(o[a].menu.length,o[a].menu.push(n[i]));return U()("name",o,t)},bt=(e,t)=>{const o=e.map(ct),n=t.map(ct);return U()("name",o,n).map(e=>{if(!e.menu)return e;const t=n.find(t=>t.name===e.name),o=t&&t.menu;return Object.assign({},e,{menu:o?bt(e.menu,o):e.menu||t.menu})})},vt=(e,t=[])=>{return Ze(e,((e=[])=>(t,o)=>{const n=e.map(e=>e.name||e);return function(e,t,o){return e<t?o?1:-1:e>t?o?-1:1:0}(st(t,n),st(o,n))})(t),it).map(e=>{if(!e.menu)return e;const o=t.find(t=>t.name===e.name),n=o&&o.menu;return Object.assign({},e,{menu:n?vt(e.menu,n):Ze(e.menu,it)})})},xt=e=>{const{query:t=""}=e||{},{entries:o,config:n}=Object(r.useContext)(d.d.context);if(!o)return null;const a=o.map(({value:e})=>e),i=ft(a),s=r.useMemo(()=>{const t=bt(i,n.menu);return((e,t)=>t?e.filter(t).map(e=>e.menu?Object.assign({},e,{menu:e.menu.filter(t)}):e):e)(vt(t,n.menu),e&&e.filter)},[o,n]);return t&&t.length>0?((e,t)=>{const o=t.map(e=>[e].concat(e.menu||[])),n=Qe(2,o),a=[...new Set(n)];return Ye(a,e,{keys:["name"]})})(t,s):s};rt.defaultProps={opened:!1};const yt=()=>{const[e,t]=Object(r.useState)(!0),[o,n]=Object(r.useState)(""),a=xt({query:o}),i=Object(d.j)().innerWidth>=Z.a.desktop,s=Object(d.i)(i);Object(r.useEffect)(()=>{e||s||!i||(t(!0),document.documentElement.classList.remove("with-overlay"))});const l=()=>{i||(t(e=>!e),(e=>{const t=e?"remove":"add";"undefined"===typeof window||i||document.documentElementyyy.classList[t]("with-overlay")})(!e))};let c=r.createElement(r.Fragment,null,r.createElement(tt,{opened:e},r.createElement(ot,null,r.createElement(We,{opened:!e,onClick:l}),r.createElement(J,{showBg:!0}),a&&0===a.length?r.createElement(at,null,"No documents founda."):r.createElement(nt,null,a&&a.map(e=>r.createElement(De,{key:e.id,item:e,sidebarToggle:l,collapseAll:Boolean(o.length)}))))),r.createElement(rt,{opened:e,onClick:l}));return o.length>0&&(c=r.createElement(r.Fragment,null,r.createElement(tt,null,r.createElement(ot,null,r.createElement(We,{opened:!e,onClick:l}),r.createElement(J,{showBg:!e}),r.createElement(be,{item:a}),r.createElement(nt,null,a&&a.map(e=>r.createElement(je,{key:e.id,item:e,sidebarToggle:l,collapseAll:Boolean(o.length)}))))))),c},kt=I.d.div`
  display: flex;
`,wt=I.d.div`
  display: flex;
  align-items: center;
...
`;var At=o("./node_modules/react-feather/dist/icons/edit-2.js"),Ot=o.n(At);const It=I.d.button`
  cursor: pointer;
  display: flex;
  align-items: center;
  outline: none;
...
`,$t=Object(I.d)(St.withComponent("a"))`
  display: flex;
  align-items: center;
  justify-content: center;
  position: absolute;
...
`,zt=Object(I.d)(Mt)`
  ...
  background: transparent;
  opacity: 0.5;
`,Nt=({props:e,getPropType:t})=>{const o=Object.entries(e),n=Object(d.f)(),a=Object(r.useMemo)(()=>Object(I.d)(n.P||"p")`
      font-size: 16px;
      color: ${Object(S.b)("colors.sidebarText")};
    `,[]);return r.createElement(r.Fragment,null,o.map(([e,o])=>o.type||o.flowType?r.createElement(Bt,{key:e},r.createElement(Lt,null,r.createElement(Ft,null,e),r.createElement(Mt,null,t(o)),o.defaultValue&&r.createElement(Rt,null,"''"===o.defaultValue.value?r.createElement("em",null,"= [Empty String]"):r.createElement("em",null,"= ",o.defaultValue.value.replace(/\'/g,'"'))),o.required&&r.createElement(zt,null,r.createElement("em",null,"required"))),o.description&&r.createElement(a,null,o.description)):null))},_t=I.d.div`
  border: 1px solid ${Object(S.b)("colors.border")};
  border-radius: 4px;
  overflow: hidden;
  background: ${Object(S.b)("colors.propsBg")};
...
`,Xt=I.d.span`
  font-size: 0.8em;
  opacity: 0.8;
`,Jt=({props:e,getPropType:t})=>{const o=Object.entries(e),n=Object(d.f)(),a=Object(r.useMemo)(()=>Object(I.d)(n.P||"p")`
      margin: 0;
      font-size: 16px;
      color: ${Object(S.b)("colors.blockquoteColor")};
      padding: 0 15px 8px 15px;
    `,[]);return r.createElement(_t,null,o.map(([e,o])=>o.type||o.flowType?r.createElement(qt,{key:e},r.createElement(Zt,null,r.createElement(Ut,null,r.createElement(Qt,null,e)),r.createElement(Gt,null,r.createElement(Yt,null,t(o))),r.createElement(Vt,null,o.defaultValue&&r.createElement(Kt,null,"''"===o.defaultValue.value?r.createElement("em",null,"= [Empty String]"):r.createElement("em",null,"= ",o.defaultValue.value.replace(/\'/g,'"'))),o.required&&r.createElement(Xt,null,r.createElement("strong",null,"required")))),o.description&&r.createElement(a,null,o.description)):null))},eo=I.d.div`
  margin: 20px 0;
`,to=I.d.div`
  overflow-x: auto;
  padding: 2px;
...
`,no={a:({href:e,...t})=>{const{separator:o,linkComponent:n}=Object(d.g)(),a=Object(d.h)(),i=Object(r.useMemo)(()=>((e,t)=>"undefined"===typeof window?null:[location.pathname.split(e).slice(0,-1).join(e).slice(1),(t||"").replace(/^(?:\.\/)+/gi,"")].join("/"))(o,e),[o,e]),s=a&&a.find(e=>e.filepath===i),l=s?s.route:e;return l&&l.startsWith("/")?r.createElement(H,$({as:n},t,{to:l})):r.createElement(H,$({},t,{href:l}))},blockquote:P,inlineCode:D,loading:()=>r.createElement(T,null,r.createElement(R,null)),notFound:()=>r.createElement(kt,null,r.createElement(yt,null),r.createElement(wt,null,r.createElement(Et,null,"Page Not Found"),r.createElement(jt,null,"Check if you changed the document route or deleted it!"))),ol:Ct,p:Tt,page:({children:e,doc:{link:t,fullpage:o,edit:n=!1}})=>{const{repository:a}=Object(d.g)(),i=r.createElement(r.Fragment,null,t&&n&&r.createElement($t,{href:t,target:"_blank"},r.createElement(Ht,{width:14})," Edit page"),e);return r.createElement(kt,null,a&&r.createElement(q,{repository:a}),!o&&r.createElement(yt,null),r.createElement(Pt,null,o?i:r.createElement(Dt,null,i)))},pre:()=>r.createElement("div",null),props:({title:e,isRaw:t,isToggle:o,...n})=>{const[a,i]=Object(r.useState)(!0),s=Object(d.f)(),l=Object(r.useMemo)(()=>Object(I.d)(s.H3||"h3")`
      padding: 8px 0;
      position: relative;
      ${t?"":"margin-bottom: 0;"}
    ...
    `,[a]),c=o?{onClick:()=>i(e=>!e),onkeydown:()=>i(e=>!e),role:"button",tabindex:0}:{};return r.createElement(eo,null,(!!e||o)&&r.createElement(l,c,e||"Component props"),a&&r.createElement("div",null,t?r.createElement(Nt,n):r.createElement(Jt,n)))},table:e=>r.createElement(to,null,r.createElement(oo,e)),ul:I.d.ul`
  list-style: none;
...
`,ro={colors:n,styles:{body:I.c`
  ...
  `,blockquote:I.c`
    ...
    font-style: italic;
    font-size: 16px;
  `},fonts:{display:'"Source Sans Pro", sans-serif',mono:'"Inconsolata", monospace',ui:'"Source Sans Pro", sans-serif'},radii:"2px",mode:"light",showPlaygroundEditor:!1,linesToScrollEditor:18};var io=o("./node_modules/react-dropdown-select/lib/index.js"),so=o.n(io);function lo(){return(lo=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const co=e=>{let{options:t,title:o,...n}=e;const[a,s]=Object(r.useState)([{id:1,href:"/",title:"Latest",label:"Latest"}]);return i.a.createElement(r.Fragment,null,i.a.createElement(so.a,lo({valueField:"id",placeholder:"Documentation",color:j,options:t,values:a,onChange:e=>{e.length>0&&s(e)}},n)))};co.propTypes={};var uo=co;Object(S.b)("colors.sidebarBg"),Object(S.b)("colors.sidebarText","#13161F"),I.d.div`
	top: 0px;
	position: absolute;
	width: 25%;
	left: 55%;
