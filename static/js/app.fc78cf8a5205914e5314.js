...
`;function D(){return(D=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const $=C.d.a`
  &,
  &:visited,
  &:active {
...
`,Pe={opened:!1},He=C.d.dl`
  ...
  visibility: ${e=>e.opened?"visible":"hidden"};
  max-height: ${e=>e.opened?"auto":"0px"};
`;He.defaultProps=Pe;const De=C.d.div`
  position: absolute;
  top: 50%;
  right: 20px;
  transform: translateY(-50%) rotate(${e=>e.opened?"-180deg":"0deg"});
...
`;De.defaultProps=Pe;const $e=e=>{const{item:t,sidebarToggle:o,handleActiveMenu:n,activeMenu:a}=e,r=ye.checkMenuIsOPen(e),s=r,l=!t.href&&t.menu&&t.menu.length>0,u=!t.href&&!t.route,c=e=>{e.preventDefault(),n(t)},d={handleActiveMenu:n,activeMenu:a};let p=i.createElement(Oe,null,i.createElement(ve,Ie({item:t},u&&{onClick:c}),` ${t.name} `,l&&i.createElement(De,{opened:s},i.createElement(ae.a,{size:15}))),l&&i.createElement(He,{opened:s},t.menu&&t.menu.map(e=>i.createElement(He,{opened:s,key:e.name},i.createElement(Se,Ie({item:e},d))))));return l||u||(p=i.createElement(Oe,null,i.createElement(ve,Ie({item:t},r&&{handleToggle:c}),`${t.name} `))),p};$e.defaultProps={item:Ce,sidebarToggle:null,collapseAll:!0},$e.defaultProps={opened:!1,hasActive:!1};const Te={opened:!0},Me=e=>e.opened?"45deg":"0deg",ze=C.d.div`
  position: relative;
  width: 23px;
  height: 32px;
