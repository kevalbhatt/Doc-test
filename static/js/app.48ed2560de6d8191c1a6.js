...
`;$e.defaultProps=Pe;const He=e=>{const[t,o]=Object(r.useState)(!0),{item:n,sidebarToggle:a,collapseAll:i}=e,s=i||t,l=!n.href&&n.submenu&&n.submenu.length>0,c=!n.href&&!n.route,d=e=>{e.preventDefault(),(()=>o(e=>!e))()};let u="";return u=(n.submenu&&n.submenu.length)>1?r.createElement(Ie,null,r.createElement(Ae,Oe({item:n},c&&{onClick:d}),`${n.name}`,l&&r.createElement($e,{opened:s},r.createElement(ce.a,{size:15}))),l&&r.createElement(De,{opened:s},n.submenu&&n.submenu.map(e=>r.createElement("dt",{key:e.name},r.createElement(Ae,{item:e,onClick:a,onActiveChange:o},`${e.name}`))))):r.createElement(Ie,null,n.submenu&&n.submenu.map(e=>r.createElement("dt",{key:e.name},r.createElement(Ae,{item:e,onActiveChange:o},`${e.name}`))))};function Te(){return(Te=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}He.defaultProps={item:Se,sidebarToggle:null,collapseAll:!0},He.defaultProps={opened:!0,hasActive:!0};const Be={id:"",name:"",route:"",href:"",menu:[],order:Number,parent:""},Le=S.d.div`
  display: flex;
  flex-direction: column;
`,Me={opened:!1},Fe=S.d.dl`
  flex: 1;
  overflow-y: auto;
  visibility: ${e=>e.opened?"visible":"hidden"};
  max-height: ${e=>e.opened?"auto":"0px"};
`;Fe.defaultProps=Me;const Re=S.d.div`
  position: absolute;
  top: 50%;
  right: 20px;
  transform: translateY(-50%) rotate(${e=>e.opened?"-180deg":"0deg"});
...
`;qe.defaultProps=ze;const We=Object(I.b)("colors.sidebarBg"),Ue=Object(I.b)("colors.sidebarPrimary"),Ge=Object(I.b)("colors.sidebarText"),Ve=Object(I.b)("colors.primary"),Ze=Object(I.b)("colors.background"),Qe=Object(I.b)("colors.text"),Ye=S.d.span`
  content: "";
  display: block;
  position: absolute;
  width: 100%;
...
`;Ye.defaultProps=ze;const Ke=Object(I.b)("radii"),Xe=S.d.button`
  cursor: pointer;
  z-index: 99;
  position: absolute;
  display: flex;
...
`;var Bt=o("./node_modules/react-feather/dist/icons/edit-2.js"),Lt=o.n(Bt);const Mt=S.d.button`
  cursor: pointer;
  display: flex;
  align-items: center;
  outline: none;
...
`,zt=Object(S.d)(Ft.withComponent("a"))`
  display: flex;
  align-items: center;
  justify-content: center;
  position: absolute;
...
//# sourceMappingURL=app.48ed2560de6d8191c1a6.js.map