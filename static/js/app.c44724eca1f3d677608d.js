...
`,C.d.input`
  ...
  font-size: 16px;
  color: ${ne};
`;var ae=o("./node_modules/react-feather/dist/icons/chevron-down.js"),ie=o.n(ae);o("./node_modules/lodash/fp/isArray.js"),o("./node_modules/@reach/router/es/index.js");const re=Object(O.b)("colors.sidebarPrimary"),se=Object(O.b)("colors.primary"),le={to:"",onClick:i.MouseEventHandler},ue=C.d.a`
  position: relative;
  font-size: 14px;
...
`,he=C.d.div`
  ...
  ${e=>e.active&&me};
`;he.defaultProps={active:!1,theme:null};const ge=e=>Object(C.d)(e)`
  position: relative;
  display: block;
  padding: 4px 15px;
  font-weight: 600;
  ...
  ${e=>fe(e)?pe:""}
`,fe=e=>{const{partiallyActive:t,to:o,children:n}=e;return t&&o.length>10&&!"REST API,ASF".includes(n.trim())},be=ge(C.d.a``),ve=(e=null,t)=>{const o=e&&e.classList.contains("active"),n=t&&(e=>{if("undefined"!==typeof window)return location.pathname.slice(0,location.pathname.length-1)===e})(t);return Boolean(o||n)},ye=(i.MouseEventHandler,i.ReactNode,i.forwardRef(({item:e,children:t,onClick:o,onActiveChange:n},a)=>{const{linkComponent:r}=Object(u.g)(),[s,l]=Object(i.useState)(!1),c=Object(u.i)(s),d=Object(i.useRef)(a),p=Object(i.useMemo)(()=>ge(r),[r]),m={children:t,onClick:o};return Object(i.useEffect)(()=>{const t=ve(d.current,e.route);c!==t&&(l(t),d&&((e,t)=>{t&&t&&!e.classList.contains("active")&&e.classList.add("active")})(d.current,t))}),i.createElement(he,{active:s},e.route?i.createElement(p,de({},m,{to:e.route,innerRef:d,activeClassName:"active",partiallyActive:!0})):i.createElement(be,de({},m,{ref:d,href:e.href||"#",target:e.href?"_blank":"_self"},!e.href&&{onClick:e=>{e.preventDefault(),m.onClick&&m.onClick(e)}})),s&&e.route&&i.createElement(ce,{route:e.route}))}));ye.displayName="MenuLink";var xe={localStorageKeys:{ACTIVEMENU:"ACTIVEMENU",NAVPOSITION:"NAVPOSITION"},checkMenuIsOPen:e=>{const{activeMenu:t,item:o}=e;return-1!==t.findIndex(e=>e===o.name)}};function ke(){return(ke=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const we={id:"",name:"",route:"",href:"",menu:[],order:Number,parent:""},Ae=C.d.div`
  display: flex;
  flex-direction: column;
`,Ee={opened:!1},je=C.d.dl`
  flex: 1;
  overflow-y: auto;
  visibility: ${e=>e.opened?"visible":"hidden"};
  max-height: ${e=>e.opened?"auto":"0px"};
`;je.defaultProps=Ee;const Se=C.d.div`
  position: absolute;
  top: 50%;
  right: 20px;
...
`;Se.defaultProps=Ee;const Ie=e=>{const{item:t,sidebarToggle:o,handleActiveMenu:n}=e,a=xe.checkMenuIsOPen(e),r=!t.href&&t.submenu&&t.submenu.length>0,s=!t.href&&!t.route,l=e=>{e.preventDefault(),n(t)};let u="";return u=(t.submenu&&t.submenu.length)>0&&t.name!==t.submenu[0].name?i.createElement(Ae,null,i.createElement(ye,ke({item:t},s&&{onClick:l}),`${t.name}`,r&&i.createElement(Se,{opened:a},i.createElement(ie.a,{size:15}))),r&&i.createElement(je,{opened:a},t.submenu&&t.menu.map(e=>i.createElement("dt",{key:e.name},i.createElement(ye,{item:e,onClick:o},`${e.name}`))))):i.createElement(Ae,null,t.submenu&&t.submenu.map(e=>i.createElement("dt",{key:e.name},i.createElement(ye,{item:e},`${e.name}`))))};function Ce(){return(Ce=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}Ie.defaultProps={item:we,sidebarToggle:null,collapseAll:!0},Ie.defaultProps={opened:!0,hasActive:!0};const Oe={id:"",name:"",route:"",href:"",menu:[],order:Number,parent:""},Pe=C.d.div`
  display: flex;
  flex-direction: column;
`,De={opened:!1},He=C.d.dl`
  flex: 1;
  overflow-y: auto;
  visibility: ${e=>e.opened?"visible":"hidden"};
  max-height: ${e=>e.opened?"auto":"0px"};
`;He.defaultProps=De;const $e=C.d.div`
  position: absolute;
  top: 50%;
  right: 20px;
  transform: translateY(-50%) rotate(${e=>e.opened?"-180deg":"0deg"});
...
`;$e.defaultProps=De;const Te=e=>{const{item:t,sidebarToggle:o,handleActiveMenu:n,activeMenu:a}=e,r=xe.checkMenuIsOPen(e),s=r,l=!t.href&&t.menu&&t.menu.length>0,u=!t.href&&!t.route,c=e=>{e.preventDefault(),n(t)},d={handleActiveMenu:n,activeMenu:a};let p=i.createElement(Pe,null,i.createElement(ye,Ce({item:t},u&&{onClick:c}),` ${t.name} `,l&&i.createElement($e,{opened:s},i.createElement(ie.a,{size:15}))),l&&i.createElement(He,{opened:s},t.menu&&t.menu.map(e=>i.createElement(He,{opened:s,key:e.name},i.createElement(Ie,Ce({item:e},d))))));return l||u||(p=i.createElement(Pe,null,i.createElement(ye,Ce({item:t},r&&{handleToggle:c}),`${t.name} `))),p};Te.defaultProps={item:Oe,sidebarToggle:null,collapseAll:!0},Te.defaultProps={opened:!1,hasActive:!1};const Me={opened:!0},ze=e=>e.opened?"45deg":"0deg",Le=C.d.div`
  position: relative;
  width: 23px;
  height: 32px;
...
`;Le.defaultProps=Me;const Be=Object(O.b)("colors.sidebarBg"),Re=Object(O.b)("colors.sidebarPrimary"),Fe=Object(O.b)("colors.sidebarText"),Ne=Object(O.b)("colors.primary"),_e=Object(O.b)("colors.background"),qe=Object(O.b)("colors.text"),We=C.d.span`
  content: "";
  display: block;
  position: absolute;
  width: 100%;
  ...
  left: 0;
  right: 0;
  background: ${e=>e.opened?Fe(e):qe(e)};
...
`;We.defaultProps=Me;const Ue=Object(O.b)("radii"),Ge=C.d.button`
  cursor: pointer;
  z-index: 99;
  position: absolute;
  display: flex;
  ...
  outline: none;
  border: none;
  background: ${e=>e.opened?Be(e):_e(e)};
  border-radius: ${e=>e.opened?`0 0 ${Ue(e)} 0`:`${Ue(e)}`};
  ...
  &:before {
    ...
    background: ${e=>Re(e)||Ne(e)};
  }

  ${Object(K.b)({display:["block","block","block","none"]})};
`;Ge.defaultProps=Me;Object.assign({},Me,{onClick:e=>null});const Ve=({opened:e,onClick:t})=>i.createElement(Ge,{opened:e,onClick:t},i.createElement(Le,{opened:e},i.createElement(We,{opened:e}),i.createElement(We,{opened:e}),i.createElement(We,{opened:e})));function Ke(e){return e&&"object"===typeof e&&"default"in e?e.default:e}const Je=Ke(o("./node_modules/lodash/fp/pipe.js")),Qe=Ke(o("./node_modules/lodash/fp/omit.js")),Ze=Ke(o("./node_modules/array-sort/index.js")),Ye=Ke(o("./node_modules/lodash/fp/flattenDepth.js")),Xe=Ke(o("./node_modules/match-sorter/dist/match-sorter.esm.js")),et=o("./node_modules/ulid/dist/index.esm.js"),tt=Object(O.b)("colors.sidebarBg"),ot=Object(O.b)("colors.sidebarText"),nt=Object(O.b)("colors.sidebarBorder"),at=C.d.div`
  position: relative;
  width: 320px;
  min-width: 320px;
  min-height: 100vh;
...
`;at.defaultProps={opened:!0,theme:""};C.d.div`
  position: relative;
`,C.d.div`
  position: fixed;
  top: 0px;
...
`,C.d.div`
  ...
  cursor: pointer;
  z-index: 99;
`);const ut=(e,t)=>e.name<t.name?-1:e.name>t.name?1:0,ct=(e,t=[])=>{const o="string"!==typeof e?V()("name",e):e,n=t.findIndex(e=>e===o);return-1!==n?n:1/0},dt=e=>!e.submenu,pt=e=>{const t=(e=>"string"===typeof e?{name:e}:e)(e);return Object.assign({},t,{id:t.id||et.ulid(),parent:V()("parent",t)||V()("parent",e),menu:Array.isArray(t.menu)?t.menu.map(pt):t.menu})},mt=Je(pt,e=>e.href||e.route?Qe("menu",e):e),ht=e=>t=>t.submenu===e,gt=e=>({name:e.name,route:e.route,parent:e.parent,submenu:e.submenu,menu:e.menu});function ft(e,t,o){return Array.from(new Set(e.reduce((e,o)=>{const n=V()(t)(o);return n?e.concat([n]):e},[])))}const bt=(e,t)=>t.filter(ht(e)).map(gt),vt=(e,t)=>t.filter(ht(e)).map(gt),yt=e=>{const t=e.filter(dt).map(gt),o=ft(e,"menu").map((e=>t=>({name:t,menu:vt(t,e)}))(e)),n=ft(e,"submenu").map(function(e){return function(t){return{name:t,submenu:bt(t,e),menu:vt(t,e)}}}(e));for(var a in o)for(var i of t)if(i.name==o[a].name){o[a]=i;break}for(var a in o)for(var r in n)o[a].name==n[r].menu[0].menu&&(o[a].menu.length,o[a].menu.push(n[r]));return U()("name",o,t)},xt=(e,t)=>{const o=e.map(mt),n=t.map(mt);return U()("name",o,n).map(e=>{if(!e.menu)return e;const t=n.find(t=>t.name===e.name),o=t&&t.menu;return Object.assign({},e,{menu:o?xt(e.menu,o):e.menu||t.menu})})},kt=(e,t=[])=>{return Ze(e,((e=[])=>(t,o)=>{const n=e.map(e=>e.name||e);return function(e,t,o){return e<t?o?1:-1:e>t?o?-1:1:0}(ct(t,n),ct(o,n))})(t),ut).map(e=>{if(!e.menu)return e;const o=t.find(t=>t.name===e.name),n=o&&o.menu;return Object.assign({},e,{menu:n?kt(e.menu,n):e.menu})})},wt=e=>{const{query:t=""}=e||{},{entries:o,config:n}=Object(i.useContext)(u.d.context);if(!o)return null;const a=o.map(({value:e})=>e),r=yt(a),s=i.useMemo(()=>{const t=xt(r,n.menu);return((e,t)=>t?e.filter(t).map(e=>e.menu?Object.assign({},e,{menu:e.menu.filter(t)}):e):e)(kt(t,n.menu),e&&e.filter)},[o,n]);return t&&t.length>0?((e,t)=>{const o=t.map(e=>[e].concat(e.menu||[])),n=Ye(2,o),a=[...new Set(n)];return Xe(a,e,{keys:["name"]})})(t,s):s};lt.defaultProps={opened:!1};const At=()=>{const[e,t]=Object(i.useState)((()=>{const{localStorageKeys:e}=xe;let t=JSON.parse(localStorage.getItem(e.ACTIVEMENU));return t||(t=["Documentation"],localStorage.setItem(e.ACTIVEMENU,JSON.stringify(t))),t})()),[o,n]=Object(i.useState)(!0),[a,r]=Object(i.useState)(""),s=wt({query:a}),l=Object(u.j)().innerWidth>=K.a.desktop,c=Object(u.i)(l),d=Object(i.useRef)();Object(i.useEffect)(()=>{o||c||!l||(n(!0),document.documentElement.classList.remove("with-overlay"))}),Object(i.useEffect)(()=>{const{localStorageKeys:e}=xe,t=parseInt(localStorage.getItem(e.NAVPOSITION));t&&(d.current.scrollTop=t)},[]);const p=()=>{l||(n(e=>!e),(e=>{const t=e?"remove":"add";"undefined"===typeof window||l||document.documentElementyyy.classList[t]("with-overlay")})(!o))},m=()=>{const{localStorageKeys:e}=xe;localStorage.setItem(e.NAVPOSITION,d.current.scrollTop)},h=o=>{const{localStorageKeys:n}=xe,a=JSON.parse(JSON.stringify(e)),i=a.findIndex(e=>e===o.name);-1===i?(a.push(o.name),t(a)):(a.splice(i,1),t([...a])),localStorage.setItem(n.ACTIVEMENU,JSON.stringify(a))};let g=i.createElement(i.Fragment,null,i.createElement(at,{opened:o},i.createElement(it,null,i.createElement(Ve,{opened:!o,onClick:p}),i.createElement(X,{showBg:!0}),s&&0===s.length?i.createElement(st,null,"No documents founda."):i.createElement(rt,{ref:d,onScroll:m},s&&s.map(t=>i.createElement(Te,{key:t.id,item:t,sidebarToggle:p,activeMenu:e,handleActiveMenu:h}))))),i.createElement(lt,{opened:o,onClick:p}));return a.length>0&&(g=i.createElement(i.Fragment,null,i.createElement(at,null,i.createElement(it,null,i.createElement(Ve,{opened:!o,onClick:p}),i.createElement(X,{showBg:!o}),i.createElement(ye,{item:s}),i.createElement(rt,{ref:d,onScroll:m},s&&s.map(e=>i.createElement(Ie,{key:e.id,item:e,sidebarToggle:p,collapseAll:Boolean(a.length)}))))))),g},Et=C.d.div`
  display: flex;
`,jt=C.d.div`
  display: flex;
  align-items: center;
...
`;var Ot=o("./node_modules/react-feather/dist/icons/edit-2.js"),Pt=o.n(Ot);const Dt=C.d.button`
  cursor: pointer;
  display: flex;
  align-items: center;
  outline: none;
...
`,Mt=Object(C.d)(Ht.withComponent("a"))`
  display: flex;
  align-items: center;
  justify-content: center;
  position: absolute;
...
`,qt=Object(C.d)(Nt)`
  ...
  background: transparent;
  opacity: 0.5;
`,Wt=({props:e,getPropType:t})=>{const o=Object.entries(e),n=Object(u.f)(),a=Object(i.useMemo)(()=>Object(C.d)(n.P||"p")`
      font-size: 16px;
      color: ${Object(O.b)("colors.sidebarText")};
    `,[]);return i.createElement(i.Fragment,null,o.map(([e,o])=>o.type||o.flowType?i.createElement(Bt,{key:e},i.createElement(Rt,null,i.createElement(Ft,null,e),i.createElement(Nt,null,t(o)),o.defaultValue&&i.createElement(_t,null,"''"===o.defaultValue.value?i.createElement("em",null,"= [Empty String]"):i.createElement("em",null,"= ",o.defaultValue.value.replace(/\'/g,'"'))),o.required&&i.createElement(qt,null,i.createElement("em",null,"required"))),o.description&&i.createElement(a,null,o.description)):null))},Ut=C.d.div`
  border: 1px solid ${Object(O.b)("colors.border")};
  border-radius: 4px;
  overflow: hidden;
  background: ${Object(O.b)("colors.propsBg")};
...
`,to=C.d.span`
  font-size: 0.8em;
  opacity: 0.8;
`,oo=({props:e,getPropType:t})=>{const o=Object.entries(e),n=Object(u.f)(),a=Object(i.useMemo)(()=>Object(C.d)(n.P||"p")`
      margin: 0;
      font-size: 16px;
      color: ${Object(O.b)("colors.blockquoteColor")};
      padding: 0 15px 8px 15px;
    `,[]);return i.createElement(Ut,null,o.map(([e,o])=>o.type||o.flowType?i.createElement(Gt,{key:e},i.createElement(Zt,null,i.createElement(Kt,null,i.createElement(Yt,null,e)),i.createElement(Jt,null,i.createElement(Xt,null,t(o))),i.createElement(Qt,null,o.defaultValue&&i.createElement(eo,null,"''"===o.defaultValue.value?i.createElement("em",null,"= [Empty String]"):i.createElement("em",null,"= ",o.defaultValue.value.replace(/\'/g,'"'))),o.required&&i.createElement(to,null,i.createElement("strong",null,"required")))),o.description&&i.createElement(a,null,o.description)):null))},no=C.d.div`
  margin: 20px 0;
`,ao=C.d.div`
  overflow-x: auto;
  padding: 2px;
...
`,ro={a:({href:e,...t})=>{const{separator:o,linkComponent:n}=Object(u.g)(),a=Object(u.h)(),r=Object(i.useMemo)(()=>((e,t)=>"undefined"===typeof window?null:[location.pathname.split(e).slice(0,-1).join(e).slice(1),(t||"").replace(/^(?:\.\/)+/gi,"")].join("/"))(o,e),[o,e]),s=a&&a.find(e=>e.filepath===r),l=s?s.route:e;return l&&l.startsWith("/")?i.createElement($,H({as:n},t,{to:l})):i.createElement($,H({},t,{href:l}))},blockquote:P,inlineCode:D,loading:()=>i.createElement(T,null,i.createElement(R,null)),notFound:()=>i.createElement(Et,null,i.createElement(At,null),i.createElement(jt,null,i.createElement(St,null,"Page Not Found"),i.createElement(It,null,"Check if you changed the document route or deleted it!"))),ol:Ct,p:Lt,page:({children:e,doc:{link:t,fullpage:o,edit:n=!1}})=>{const{repository:a}=Object(u.g)(),r=i.createElement(i.Fragment,null,t&&n&&i.createElement(Mt,{href:t,target:"_blank"},i.createElement(zt,{width:14})," Edit page"),e);return i.createElement(Et,null,a&&i.createElement(q,{repository:a}),!o&&i.createElement(At,null),i.createElement($t,null,o?r:i.createElement(Tt,null,r)))},pre:()=>i.createElement("div",null),props:({title:e,isRaw:t,isToggle:o,...n})=>{const[a,r]=Object(i.useState)(!0),s=Object(u.f)(),l=Object(i.useMemo)(()=>Object(C.d)(s.H3||"h3")`
      padding: 8px 0;
      position: relative;
      ${t?"":"margin-bottom: 0;"}
    ...
    `,[a]),c=o?{onClick:()=>r(e=>!e),onkeydown:()=>r(e=>!e),role:"button",tabindex:0}:{};return i.createElement(no,null,(!!e||o)&&i.createElement(l,c,e||"Component props"),a&&i.createElement("div",null,t?i.createElement(Wt,n):i.createElement(oo,n)))},table:e=>i.createElement(ao,null,i.createElement(io,e)),ul:C.d.ul`
  list-style: none;
...
`,lo={colors:n,styles:{body:C.c`
  ...
  `,blockquote:C.c`
    ...
    font-style: italic;
    font-size: 16px;
  `},fonts:{display:'"Source Sans Pro", sans-serif',mono:'"Inconsolata", monospace',ui:'"Source Sans Pro", sans-serif'},radii:"2px",mode:"light",showPlaygroundEditor:!1,linesToScrollEditor:18};var uo=o("./node_modules/react-dropdown-select/lib/index.js"),co=o.n(uo);function po(){return(po=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const mo=e=>{let{options:t,...o}=e;const[n,a]=Object(i.useState)([{id:1,href:"/",title:"Latest",label:"Latest"}]),s=C.d.div` > div { display: inline-block; width: 145px } label {margin-right: 5px}`;return r.a.createElement(s,null,r.a.createElement(i.Fragment,null,r.a.createElement("label",null,"Versions:"),r.a.createElement(co.a,po({valueField:"id",placeholder:"Documentation",color:E,options:t,values:n,onChange:e=>{if(e.length>0&&n!==e){let t=e[0].href,o="_self";a(e),"Latest"!==e[0].title&&(t=`http://atlas.apache.org/${e[0].href}`,o="_blank"),window.open(t,o)}}},o))))};mo.propTypes={};var ho=mo;Object(O.b)("colors.sidebarBg"),Object(O.b)("colors.sidebarText","#13161F"),C.d.div`
	top: 0px;
	position: absolute;
	width: 25%;
	left: 55%;
...
`,fo=C.d.div`
	...
	right: 250px;
	width: 220px;
`,bo=()=>{const{config:e}=Object(i.useContext)(u.d.context),{atlasVersions:t}=e;return r.a.createElement(go,null,r.a.createElement(fo,null,r.a.createElement(ho,{options:t,style:{minHeight:"auto",padding:"0 5px",borderRadius:"5px"}})))},vo=(Object(O.b)("colors.sidebarBg"),Object(O.b)("colors.sidebarText","#13161F"),C.d.a`
  &,
  &:visited,
  &:active {
    text-decoration: none;
