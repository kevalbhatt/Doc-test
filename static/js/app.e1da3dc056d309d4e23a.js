...
`,({showBg:e})=>{const{base:t,title:o,linkComponent:n,logo:a}=Object(d.g)();return n?r.createElement(oe,{showBg:e},r.createElement(n,{to:"string"===typeof t?t:"/"},r.createElement(ne,{src:"images/atlas-logo-grey.png",width:"100",alt:o}))):null});var re=o("./node_modules/react-feather/dist/icons/search.js"),ie=o.n(re);const se=j("colors.sidebarBorder","#CED4DE"),le=j("colors.sidebarText","#13161F"),de=P.d.div`
  display: flex;
  align-items: center;
  padding: 5px 24px;
  margin-bottom: 20px;
...
`,ce=P.d.input`
  ...
  font-size: 16px;
  color: ${le};
`,pe=({onSearch:e})=>r.createElement(de,null,r.createElement(ue,null),r.createElement(ce,{type:"text",placeholder:"Search here...",onChange:t=>{e&&e(t.target.value)}}));pe.defaultProps={onSearch:e=>{}};var me=o("./node_modules/react-feather/dist/icons/chevron-down.js"),he=o.n(me),ge=o("./node_modules/@reach/router/es/index.js");function fe(){return(fe=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const ve=j("colors.sidebarPrimary"),be=j("colors.primary"),xe={to:"",onClick:r.MouseEventHandler},ye=P.d.a`
  position: relative;
  font-size: 14px;
...
`;ye.defaultProps=xe;const ke=Object.assign({},xe,{as:null,slug:""}),we=({as:e,slug:t,location:o,...n})=>{const[a,i]=Object(r.useState)(!1);return Object(r.useEffect)(()=>{const e=decodeURI(o.hash),n=e&&e.slice(1,1/0);i(Boolean(t===n))},[o]),r.createElement(ye,fe({as:e},n,{className:a?"active":""}))};we.defaultProps=ke;const Ee=P.d.div`
  display: flex;
  flex-direction: column;
  margin: 5px 0 0 24px;
`,Ce=({route:e,onClick:t})=>{const o=Object(d.h)(),{linkComponent:n}=Object(d.g)(),a=o&&((e,t)=>{const o=t.find(t=>t.route===e),n=c()(o,"headings");return n?n.filter(e=>2===e.depth):[]})(e,o);return a&&a.length>0?r.createElement(ge.b,null,({location:o})=>r.createElement(Ee,null,a.map(a=>r.createElement(we,{as:n,location:o,key:a.slug,onClick:t,to:`${e}#${a.slug}`,slug:a.slug},a.value)))):null};function Ae(){return(Ae=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const Se=P.c`
  padding-left: 0;
  &:after {
    width: 1px;
  }
`,Ie=P.d.div`
  ...
  ${e=>e.active&&Se};
`;Ie.defaultProps={active:!1,theme:null};const Pe=e=>Object(P.d)(e)`
  position: relative;
  display: block;
  padding: 4px 24px;
  font-weight: 600;
...
`,je=Pe(P.d.a``),De=(e=null,t)=>{const o=e&&e.classList.contains("active"),n=t&&(e=>{if("undefined"!==typeof window)return location.pathname.slice(0,location.pathname.length-1)===e})(t);return Boolean(o||n)},$e=(r.MouseEventHandler,r.ReactNode,r.forwardRef(({item:e,children:t,onClick:o,onActiveChange:n},a)=>{const{linkComponent:i}=Object(d.g)(),[s,l]=Object(r.useState)(!1),u=Object(d.i)(s),c=Object(r.useRef)(a),p=Object(r.useMemo)(()=>Pe(i),[i]),m={children:t,onClick:o};return Object(r.useEffect)(()=>{const t=De(c.current,e.route);u!==t&&(l(t),c&&((e,t)=>{t&&t&&!e.classList.contains("active")&&e.classList.add("active")})(c.current,t),n&&n(t))}),r.createElement(Ie,{active:s},e.route?r.createElement(p,Ae({},m,{to:e.route,innerRef:c,activeClassName:"active",partiallyActive:!0})):r.createElement(je,Ae({},m,{ref:c,href:e.href||"#",target:e.href?"_blank":"_self"},!e.href&&{onClick:e=>{e.preventDefault(),m.onClick&&m.onClick(e)}})),s&&e.route&&r.createElement(Ce,{route:e.route}))}));function Oe(){return(Oe=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}$e.displayName="MenuLink";const He={id:"",name:"",route:"",href:"",menu:[],order:Number,parent:""},Te=P.d.div`
  display: flex;
  flex-direction: column;
`,Be={opened:!1},Le=P.d.dl`
  flex: 1;
  overflow-y: auto;
  visibility: ${e=>e.opened?"visible":"hidden"};
  max-height: ${e=>e.opened?"auto":"0px"};
`;Le.defaultProps=Be;const Me=P.d.div`
  position: absolute;
  top: 50%;
  right: 20px;
...
`;Me.defaultProps=Be;const Fe=e=>{const[t,o]=Object(r.useState)(!0),{item:n,sidebarToggle:a,collapseAll:i}=e,s=i||t,l=!n.href&&n.submenu&&n.submenu.length>0,d=!n.href&&!n.route,u=e=>{e.preventDefault(),(()=>o(e=>!e))()};let c="";return c=(n.submenu&&n.submenu.length)>1?r.createElement(Te,null,r.createElement($e,Oe({item:n},d&&{onClick:u}),`${n.name}`,l&&r.createElement(Me,{opened:s},r.createElement(he.a,{size:15}))),l&&r.createElement(Le,{opened:s},n.submenu&&n.submenu.map(e=>r.createElement("dt",{key:e.name},r.createElement($e,{item:e,onClick:a,onActiveChange:o},`${e.name}`))))):r.createElement(Te,null,n.submenu&&n.submenu.map(e=>r.createElement("dt",{key:e.name},r.createElement($e,{item:e,onActiveChange:o},`${e.name}`))))};function Ne(){return(Ne=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}Fe.defaultProps={item:He,sidebarToggle:null,collapseAll:!0},Fe.defaultProps={opened:!0,hasActive:!0};const Re={id:"",name:"",route:"",href:"",menu:[],order:Number,parent:""},ze=P.d.div`
  display: flex;
  flex-direction: column;
`,_e={opened:!1},qe=P.d.dl`
  flex: 1;
  overflow-y: auto;
  visibility: ${e=>e.opened?"visible":"hidden"};
  max-height: ${e=>e.opened?"auto":"0px"};
`;qe.defaultProps=_e;const We=P.d.div`
  position: absolute;
  top: 50%;
  right: 20px;
  transform: translateY(-50%) rotate(${e=>e.opened?"-180deg":"0deg"});
...
`;We.defaultProps=_e;const Ue=e=>{const[t,o]=Object(r.useState)(!0),{item:n,sidebarToggle:a,collapseAll:i}=e,s=i||t,l=!n.href&&n.menu&&n.menu.length>0,d=!n.href&&!n.route,u=e=>{e.preventDefault(),(()=>o(e=>!e))()};let c=r.createElement(ze,null,r.createElement($e,Ne({item:n},d&&{onClick:u}),` ${n.name} `,l&&r.createElement(We,{opened:s},r.createElement(he.a,{size:15}))),l&&r.createElement(qe,{opened:s},n.menu&&n.menu.map(e=>r.createElement(qe,{opened:s,key:e.name},r.createElement(Fe,{item:e})))));return l||d||(c=r.createElement(ze,null,r.createElement($e,Ne({item:n},t&&{handleToggle:u}),`${n.name} `))),c};Ue.defaultProps={item:Re,sidebarToggle:null,collapseAll:!0},Ue.defaultProps={opened:!1,hasActive:!1};const Ge={opened:!0},Ve=e=>e.opened?"45deg":"0deg",Ze=P.d.div`
  position: relative;
  width: 23px;
  height: 32px;
...
`;Ze.defaultProps=Ge;const Qe=j("colors.sidebarBg"),Ye=j("colors.sidebarPrimary"),Ke=j("colors.sidebarText"),Xe=j("colors.primary"),Je=j("colors.background"),et=j("colors.text"),tt=P.d.span`
  content: "";
  display: block;
  position: absolute;
  width: 100%;
  ...
  left: 0;
  right: 0;
  background: ${e=>e.opened?Ke(e):et(e)};
  transition: transform 0.3s, opacity 0.3s;

  &:nth-of-type(1) {
    top: -2px;
    transform: translateY(${e=>e.opened?"10px":"0px"}) rotate(${Ve});
  }
  ...
  &:nth-of-type(3) {
    top: 14px;
    transform: translateY(${e=>e.opened?"-6px":"0px"}) rotate(-${Ve});
  }
`;tt.defaultProps=Ge;const ot=j("radii"),nt=P.d.button`
  cursor: pointer;
  z-index: 99;
  position: absolute;
  display: flex;
  ...
  outline: none;
  border: none;
  background: ${e=>e.opened?Qe(e):Je(e)};
  border-radius: ${e=>e.opened?`0 0 ${ot(e)} 0`:`${ot(e)}`};
  ...
  &:before {
    ...
    background: ${e=>Ye(e)||Xe(e)};
  }

  ${J({display:["block","block","block","none"]})};
`;nt.defaultProps=Ge;Object.assign({},Ge,{onClick:e=>null});const at=({opened:e,onClick:t})=>r.createElement(nt,{opened:e,onClick:t},r.createElement(Ze,{opened:e},r.createElement(tt,{opened:e}),r.createElement(tt,{opened:e}),r.createElement(tt,{opened:e})));function rt(e){return e&&"object"===typeof e&&"default"in e?e.default:e}const it=rt(o("./node_modules/lodash/fp/pipe.js")),st=rt(o("./node_modules/lodash/fp/omit.js")),lt=rt(o("./node_modules/array-sort/index.js")),dt=rt(o("./node_modules/lodash/fp/flattenDepth.js")),ut=rt(o("./node_modules/match-sorter/dist/match-sorter.esm.js")),ct=o("./node_modules/ulid/dist/index.esm.js"),pt=j("colors.sidebarBg"),mt=j("colors.sidebarText"),ht=j("colors.sidebarBorder"),gt=P.d.div`
  position: relative;
  width: 320px;
  min-width: 320px;
  min-height: 100vh;
  ...
  ${j("styles.sidebar")};
`;gt.defaultProps={opened:!0,theme:""};P.d.div`
  position: relative;
`,P.d.div`
  position: fixed;
  top: 0px;
...
`,P.d.div`
  ...
  cursor: pointer;
  z-index: 99;
`);const yt=(e,t)=>e.name<t.name?-1:e.name>t.name?1:0,kt=(e,t=[])=>{const o="string"!==typeof e?Z()("name",e):e,n=t.findIndex(e=>e===o);return-1!==n?n:1/0},wt=e=>!e.submenu,Et=e=>{const t=(e=>"string"===typeof e?{name:e}:e)(e);return Object.assign({},t,{id:t.id||ct.ulid(),parent:Z()("parent",t)||Z()("parent",e),menu:Array.isArray(t.menu)?t.menu.map(Et):t.menu})},Ct=it(Et,e=>e.href||e.route?st("menu",e):e),At=e=>t=>t.submenu===e,St=e=>({name:e.name,route:e.route,parent:e.parent,submenu:e.submenu});function It(e,t){return Array.from(new Set(e.reduce((e,o)=>{const n=Z()(t)(o);return n?e.concat([n]):e},[])))}const Pt=(e,t)=>t.filter(At(e)).map(St),jt=(e,t)=>t.filter(At(e)).map(St),Dt=e=>{const t=e.filter(wt).map(St),o=It(e,"menu").map((e=>t=>({name:t,menu:jt(t,e)}))(e)),n=It(e,"submenu").map((e=>t=>({name:t,submenu:Pt(t,e)}))(e));for(var a in o)for(var r of t)if(r.name==o[a].name){o[a]=r;break}return o[0].menu=n,G()("name",o,t)},$t=(e,t)=>{const o=e.map(Ct),n=t.map(Ct);return G()("name",o,n).map(e=>{if(!e.menu)return e;const t=n.find(t=>t.name===e.name),o=t&&t.menu;return Object.assign({},e,{menu:o?$t(e.menu,o):e.menu||t.menu})})},Ot=(e,t=[])=>{return lt(e,((e=[])=>(t,o)=>{const n=e.map(e=>e.name||e);return function(e,t,o){return e<t?o?1:-1:e>t?o?-1:1:0}(kt(t,n),kt(o,n))})(t),yt).map(e=>{if(!e.menu)return e;const o=t.find(t=>t.name===e.name),n=o&&o.menu;return Object.assign({},e,{menu:n?Ot(e.menu,n):lt(e.menu,yt)})})},Ht=e=>{const{query:t=""}=e||{},{entries:o,config:n}=Object(r.useContext)(d.d.context);if(!o)return null;const a=o.map(({value:e})=>e),i=Dt(a),s=r.useMemo(()=>{const t=$t(i,n.menu);return((e,t)=>t?e.filter(t).map(e=>e.menu?Object.assign({},e,{menu:e.menu.filter(t)}):e):e)(Ot(t,n.menu),e&&e.filter)},[o,n]);return t&&t.length>0?((e,t)=>{const o=t.map(e=>[e].concat(e.menu||[])),n=dt(2,o),a=[...new Set(n)];return ut(a,e,{keys:["name"]})})(t,s):s};xt.defaultProps={opened:!1};const Tt=()=>{const[e,t]=Object(r.useState)(!0),[o,n]=Object(r.useState)(""),a=Ht({query:o}),i=Object(d.j)().innerWidth>=X,s=Object(d.i)(i);Object(r.useEffect)(()=>{e||s||!i||(t(!0),document.documentElement.classList.remove("with-overlay"))});const l=()=>{i||(t(e=>!e),(e=>{const t=e?"remove":"add";"undefined"===typeof window||i||document.documentElementyyy.classList[t]("with-overlay")})(!e))};let u=r.createElement(r.Fragment,null,r.createElement(gt,{opened:e},r.createElement(ft,null,r.createElement(at,{opened:!e,onClick:l}),r.createElement(ae,{showBg:!0}),r.createElement(pe,{onSearch:n}),a&&0===a.length?r.createElement(bt,null,"No documents founda."):r.createElement(vt,null,a&&a.map(e=>r.createElement(Ue,{key:e.id,item:e,sidebarToggle:l,collapseAll:Boolean(o.length)}))))),r.createElement(xt,{opened:e,onClick:l}));return o.length>0&&(u=r.createElement(r.Fragment,null,r.createElement(gt,null,r.createElement(ft,null,r.createElement(at,{opened:!e,onClick:l}),r.createElement(ae,{showBg:!e}),r.createElement(pe,{onSearch:n}),r.createElement($e,{item:a}),r.createElement(vt,null,a&&a.map(e=>r.createElement(Fe,{key:e.id,item:e,sidebarToggle:l,collapseAll:Boolean(o.length)}))))))),u},Bt=P.d.div`
  display: flex;
`,Lt=P.d.div`
  display: flex;
  align-items: center;
...
`,Nt=P.d.ol`
  ...
  ${j("styles.ol")};
`;var Rt=o("./node_modules/react-feather/dist/icons/edit-2.js"),zt=o.n(Rt);const _t=P.d.button`
  cursor: pointer;
  display: flex;
  align-items: center;
  outline: none;
...
`,Ut=P.d.div`
  ...
  ${j("styles.container")};
`,Gt=Object(P.d)(qt.withComponent("a"))`
  display: flex;
  align-items: center;
  justify-content: center;
  position: absolute;
...
`,eo=Object(P.d)(Xt)`
  ...
  background: transparent;
  opacity: 0.5;
`,to=({props:e,getPropType:t})=>{const o=Object.entries(e),n=Object(d.f)(),a=Object(r.useMemo)(()=>Object(P.d)(n.P||"p")`
      font-size: 16px;
      color: ${j("colors.sidebarText")};
    `,[]);return r.createElement(r.Fragment,null,o.map(([e,o])=>o.type||o.flowType?r.createElement(Qt,{key:e},r.createElement(Yt,null,r.createElement(Kt,null,e),r.createElement(Xt,null,t(o)),o.defaultValue&&r.createElement(Jt,null,"''"===o.defaultValue.value?r.createElement("em",null,"= [Empty String]"):r.createElement("em",null,"= ",o.defaultValue.value.replace(/\'/g,'"'))),o.required&&r.createElement(eo,null,r.createElement("em",null,"required"))),o.description&&r.createElement(a,null,o.description)):null))},oo=P.d.div`
  border: 1px solid ${j("colors.border")};
  border-radius: 4px;
  overflow: hidden;
  background: ${j("colors.propsBg")};
...
`,mo=P.d.span`
  font-size: 0.8em;
  opacity: 0.8;
`,ho=({props:e,getPropType:t})=>{const o=Object.entries(e),n=Object(d.f)(),a=Object(r.useMemo)(()=>Object(P.d)(n.P||"p")`
      margin: 0;
      font-size: 16px;
      color: ${j("colors.blockquoteColor")};
      padding: 0 15px 8px 15px;
    `,[]);return r.createElement(oo,null,o.map(([e,o])=>o.type||o.flowType?r.createElement(no,{key:e},r.createElement(lo,null,r.createElement(ro,null,r.createElement(uo,null,e)),r.createElement(io,null,r.createElement(co,null,t(o))),r.createElement(so,null,o.defaultValue&&r.createElement(po,null,"''"===o.defaultValue.value?r.createElement("em",null,"= [Empty String]"):r.createElement("em",null,"= ",o.defaultValue.value.replace(/\'/g,'"'))),o.required&&r.createElement(mo,null,r.createElement("strong",null,"required")))),o.description&&r.createElement(a,null,o.description)):null))},go=P.d.div`
  margin: 20px 0;
`,fo=P.d.div`
  overflow-x: auto;
  padding: 2px;
...
`,vo=P.d.table`
  ...
  ${j("styles.table")};
`,bo={a:({href:e,...t})=>{const{separator:o,linkComponent:n}=Object(d.g)(),a=Object(d.h)(),i=Object(r.useMemo)(()=>((e,t)=>"undefined"===typeof window?null:[location.pathname.split(e).slice(0,-1).join(e).slice(1),(t||"").replace(/^(?:\.\/)+/gi,"")].join("/"))(o,e),[o,e]),s=a&&a.find(e=>e.filepath===i),l=s?s.route:e;return l&&l.startsWith("/")?r.createElement(T,H({as:n},t,{to:l})):r.createElement(T,H({},t,{href:l}))},blockquote:$,inlineCode:O,loading:()=>r.createElement(B,null,r.createElement(R,null)),notFound:()=>r.createElement(Bt,null,r.createElement(Tt,null),r.createElement(Lt,null,r.createElement(Mt,null,"Page Not Found"),r.createElement(Ft,null,"Check if you changed the document route or deleted it!"))),ol:Nt,p:Zt,page:({children:e,doc:{link:t,fullpage:o,edit:n=!1}})=>{const{repository:a}=Object(d.g)(),i=r.createElement(r.Fragment,null,t&&n&&r.createElement(Gt,{href:t,target:"_blank"},r.createElement(Vt,{width:14})," Edit page"),e);return r.createElement(Bt,null,a&&r.createElement(W,{repository:a}),!o&&r.createElement(Tt,null),r.createElement(Wt,null,o?i:r.createElement(Ut,null,i)))},pre:()=>r.createElement("div",null),props:({title:e,isRaw:t,isToggle:o,...n})=>{const[a,i]=Object(r.useState)(!0),s=Object(d.f)(),l=Object(r.useMemo)(()=>Object(P.d)(s.H3||"h3")`
      padding: 8px 0;
      position: relative;
      ${t?"":"margin-bottom: 0;"}
    ...
    `,[a]),u=o?{onClick:()=>i(e=>!e),onkeydown:()=>i(e=>!e),role:"button",tabindex:0}:{};return r.createElement(go,null,(!!e||o)&&r.createElement(l,u,e||"Component props"),a&&r.createElement("div",null,t?r.createElement(to,n):r.createElement(ho,n)))},table:e=>r.createElement(fo,null,r.createElement(vo,e)),ul:P.d.ul`
  list-style: none;
...
`,yo={colors:n,styles:{body:P.c`
  ...
  `,blockquote:P.c`
    ...
    font-style: italic;
    font-size: 16px;
  `},fonts:{display:'"Source Sans Pro", sans-serif',mono:'"Inconsolata", monospace',ui:'"Source Sans Pro", sans-serif'},radii:"2px",mode:"light",showPlaygroundEditor:!1,linesToScrollEditor:18};var ko=o("./node_modules/react-dropdown-select/lib/index.js"),wo=o.n(ko);function Eo(){return(Eo=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const Co=e=>{let{options:t,title:o,...n}=e;return i.a.createElement(r.Fragment,null,i.a.createElement(wo.a,Eo({placeholder:"Documentation",color:C,options:t,onChange:e=>{e.length>0&&window.open(e[0].href,"_blank")}},n)))};Co.propTypes={};var Ao=Co;j("colors.sidebarBg"),j("colors.sidebarText","#13161F"),P.d.div`
	top: 0px;
	position: absolute;
	width: 25%;
	left: 55%;
