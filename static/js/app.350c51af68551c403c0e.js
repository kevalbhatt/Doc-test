...
`,T=j.d.code`
	...
	${P("styles.code")};
`;function H(){return(H=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const $=j.d.a`
  &,
  &:visited,
  &:active {
...
`;_e.defaultProps=Le;const Re=e=>{const{item:t,sidebarToggle:o,handleActiveMenu:n,activeMenu:a}=e,i=Se.checkMenuIsOPen(e),s=i,l=!t.href&&t.menu&&t.menu.length>0,u=!t.href&&!t.route,d=e=>{e.preventDefault(),n(t)},c={handleActiveMenu:n,activeMenu:a};let p=r.createElement(ze,null,r.createElement(Ae,He({item:t},u&&{onClick:d}),` ${t.name} `,l&&r.createElement(_e,{opened:s},r.createElement(de.a,{size:15}))),l&&r.createElement(Me,{opened:s},t.menu&&t.menu.map(e=>r.createElement(Me,{opened:s,key:e.name},r.createElement(Te,He({item:e},c))))));return l||u||(p=r.createElement(ze,null,r.createElement(Ae,He({item:t},i&&{handleToggle:d}),`${t.name} `))),p};Re.defaultProps={item:$e,sidebarToggle:null,collapseAll:!0},Re.defaultProps={opened:!1,hasActive:!1};const Ne={opened:!0},Be=e=>e.opened?"45deg":"0deg",Fe=j.d.div`
  position: relative;
  width: 23px;
  height: 32px;
...
`,vo=j.d.table`
  ...
  ${P("styles.table")};
`,bo={a:({href:e,...t})=>{const{separator:o,linkComponent:n}=Object(u.useConfig)(),a=Object(u.useDocs)(),i=Object(r.useMemo)(()=>((e,t)=>"undefined"===typeof window?null:[location.pathname.split(e).slice(0,-1).join(e).slice(1),(t||"").replace(/^(?:\.\/)+/gi,"")].join("/"))(o,e),[o,e]),s=a&&a.find(e=>e.filepath===i),l=s?s.route:e;return l&&l.startsWith("/")?r.createElement($,H({as:n},t,{to:l})):r.createElement($,H({},t,{href:l}))},blockquote:D,inlineCode:T,loading:()=>r.createElement(z,null,r.createElement(N,null)),notFound:()=>r.createElement(Pt,null,r.createElement(jt,null),r.createElement(Ot,null,r.createElement(Dt,null,"Page Not Found"),r.createElement(Tt,null,"Check if you changed the document route or deleted it!"))),ol:Ht,p:Kt,page:({children:e,doc:{link:t,fullpage:o,edit:n=!1}})=>{const{repository:a}=Object(u.useConfig)(),{props:i}=e,s=Se.pagesForGithubLink.toString().includes(i.doc.name),l=r.createElement(r.Fragment,null,t&&n&&r.createElement(Gt,{href:t,target:"_blank"},r.createElement(Vt,{width:14})," Edit page"),r.createElement(Wt,{showGithubLink:s}),e);return r.createElement(Pt,null,a&&r.createElement(W,{repository:a}),!o&&r.createElement(jt,null),r.createElement(qt,null,o?l:r.createElement(Ut,null,l)))},pre:()=>r.createElement("div",null),props:({title:e,isRaw:t,isToggle:o,...n})=>{const[a,i]=Object(r.useState)(!0),s=Object(u.useComponents)(),l=Object(r.useMemo)(()=>Object(j.d)(s.H3||"h3")`
      padding: 8px 0;
      position: relative;
      ${t?"":"margin-bottom: 0;"}
