...
`;He.defaultProps=Pe;const $e=e=>{const{item:t,sidebarToggle:o,handleActiveMenu:n,activeMenu:a}=e,r=ye.checkMenuIsOPen(e),s=r,l=!t.href&&t.menu&&t.menu.length>0,u=!t.href&&!t.route,c=e=>{e.preventDefault(),n(t)},d={handleActiveMenu:n,activeMenu:a};let p=i.createElement(Oe,null,i.createElement(ve,Ie({item:t},u&&{onClick:c}),` ${t.name} `,l&&i.createElement(He,{opened:s},i.createElement(ae.a,{size:15}))),l&&i.createElement(De,{opened:s},t.menu&&t.menu.map(e=>i.createElement(De,{opened:s,key:e.name},i.createElement(Se,Ie({item:e},d))))));return l||u||(p=i.createElement(Oe,null,i.createElement(ve,Ie({item:t},r&&{handleToggle:c}),`${t.name} `))),p};$e.defaultProps={item:Ce,sidebarToggle:null,collapseAll:!0},$e.defaultProps={opened:!1,hasActive:!1};const Te={opened:!0},Me=e=>e.opened?"45deg":"0deg",ze=C.d.div`
  position: relative;
  width: 23px;
  height: 32px;
