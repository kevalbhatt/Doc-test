...
`,ro={colors:n,styles:{body:I.c`
  ...
  `,blockquote:I.c`
    ...
    font-style: italic;
    font-size: 16px;
  `},fonts:{display:'"Source Sans Pro", sans-serif',mono:'"Inconsolata", monospace',ui:'"Source Sans Pro", sans-serif'},radii:"2px",mode:"light",showPlaygroundEditor:!1,linesToScrollEditor:18};var io=o("./node_modules/react-dropdown-select/lib/index.js"),so=o.n(io);function lo(){return(lo=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const co=e=>{let{options:t,...o}=e;const[n,a]=Object(r.useState)([{id:1,href:"/",title:"Latest",label:"Latest"}]),s=I.d.div` > div { display: inline-block } label {margin-right: 5px}`;return i.a.createElement(s,null,i.a.createElement(r.Fragment,null,i.a.createElement("label",null,"Versions:"),i.a.createElement(so.a,lo({valueField:"id",placeholder:"Documentation",color:j,options:t,values:n,onChange:e=>{if(e.length>0&&n!==e){let t=e[0].href,o="_self";a(e),"Latest"!==e[0].title&&(t=`http://atlas.apache.org/${e[0].href}`,o="_blank"),window.open(t,o)}}},o))))};co.propTypes={};var uo=co;Object(S.b)("colors.sidebarBg"),Object(S.b)("colors.sidebarText","#13161F"),I.d.div`
	top: 0px;
	position: absolute;
	width: 25%;
	left: 55%;
