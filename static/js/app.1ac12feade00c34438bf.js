...
`,je=Ee(S.d.a``),Ce=(e=null,t)=>{const o=e&&e.classList.contains("active"),n=t&&(e=>{if("undefined"!==typeof window)return location.pathname.slice(0,location.pathname.length-1)===e})(t);return Boolean(o||n)},Oe=(r.MouseEventHandler,r.ReactNode,r.forwardRef(({item:e,children:t,onClick:o,onActiveChange:n},a)=>{const{linkComponent:i}=Object(c.g)(),[s,l]=Object(r.useState)(!1),d=Object(c.i)(s),u=Object(r.useRef)(a),p=Object(r.useMemo)(()=>Ee(i),[i]),m={children:t,onClick:o};return Object(r.useEffect)(()=>{const t=Ce(u.current,e.route);d!==t&&(l(t),u&&((e,t)=>{t&&t&&!e.classList.contains("active")&&e.classList.add("active")})(u.current,t),n&&n(t))}),r.createElement(we,{active:s},e.route?r.createElement(p,ye({},m,{to:e.route,innerRef:u,activeClassName:"active",partiallyActive:!0})):r.createElement(je,ye({},m,{ref:u,href:e.href||"#",target:e.href?"_blank":"_self"},!e.href&&{onClick:e=>{e.preventDefault(),m.onClick&&m.onClick(e)}})),s&&e.route&&r.createElement(xe,{route:e.route}))}));function Ae(){return(Ae=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}Oe.displayName="MenuLink";const Se={id:"",name:"",route:"",href:"",menu:[],order:Number,parent:""},Ie=S.d.div`
  display: flex;
  flex-direction: column;
