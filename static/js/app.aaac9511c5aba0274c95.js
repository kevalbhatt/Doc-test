...
`;function $(){return($=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const D=C.d.a`
  &,
  &:visited,
  &:active {
...
`,({showBg:e})=>{const{base:t,title:o,linkComponent:n,baseUrl:a}=Object(u.g)();return n?i.createElement(Q,{showBg:e},i.createElement(n,{to:"string"===typeof t?t:"/"},i.createElement(Z,{src:`${a}/images/atlas-logo-grey.png`,alt:o}))):null});var X=o("./node_modules/react-feather/dist/icons/search.js"),ee=o.n(X);const te=Object(O.b)("colors.sidebarBorder","#CED4DE"),oe=Object(O.b)("colors.sidebarText","#13161F");C.d.div`
  display: flex;
  align-items: center;
  padding: 5px 24px;
  margin-bottom: 20px;
...
`,C.d.input`
  ...
  font-size: 16px;
  color: ${oe};
`;var ne=o("./node_modules/react-feather/dist/icons/chevron-down.js"),ae=o.n(ne);o("./node_modules/lodash/fp/isArray.js"),o("./node_modules/@reach/router/es/index.js");const ie=Object(O.b)("colors.sidebarPrimary"),re=Object(O.b)("colors.primary"),se={to:"",onClick:i.MouseEventHandler},le=C.d.a`
  position: relative;
  font-size: 14px;
...
`;je.defaultProps=Ae;const Se=e=>{const{item:t,sidebarToggle:o,handleActiveMenu:n}=e,a=ye.checkMenuIsOPen(e),r=!t.href&&t.submenu&&t.submenu.length>0,s=!t.href&&!t.route,l=e=>{e.preventDefault(),n(t)};let u="";return u=(t.submenu&&t.submenu.length)>0&&t.name!==t.submenu[0].name?i.createElement(we,null,i.createElement(ve,xe({item:t},s&&{onClick:l}),`${t.name}`,r&&i.createElement(je,{opened:a},i.createElement(ae.a,{size:15}))),r&&i.createElement(Ee,{opened:a},t.submenu&&t.menu.map(e=>i.createElement("dt",{key:e.name},i.createElement(ve,{item:e,onClick:o},`${e.name}`))))):i.createElement(we,null,t.submenu&&t.submenu.map(e=>i.createElement("dt",{key:e.name},i.createElement(ve,{item:e},`${e.name}`))))};function Ie(){return(Ie=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}Se.defaultProps={item:ke,sidebarToggle:null,collapseAll:!0},Se.defaultProps={opened:!0,hasActive:!0};const Ce={id:"",name:"",route:"",href:"",menu:[],order:Number,parent:""},Oe=C.d.div`
  display: flex;
  flex-direction: column;
`,Pe={opened:!1},He=C.d.dl`
  flex: 1;
  overflow-y: auto;
  visibility: ${e=>e.opened?"visible":"hidden"};
  max-height: ${e=>e.opened?"auto":"0px"};
`;He.defaultProps=Pe;const $e=C.d.div`
  position: absolute;
  top: 50%;
  right: 20px;
  transform: translateY(-50%) rotate(${e=>e.opened?"-180deg":"0deg"});
...
`;$e.defaultProps=Pe;const De=e=>{const{item:t,sidebarToggle:o,handleActiveMenu:n,activeMenu:a}=e,r=ye.checkMenuIsOPen(e),s=r,l=!t.href&&t.menu&&t.menu.length>0,u=!t.href&&!t.route,c=e=>{e.preventDefault(),n(t)},d={handleActiveMenu:n,activeMenu:a};let p=i.createElement(Oe,null,i.createElement(ve,Ie({item:t},u&&{onClick:c}),` ${t.name} `,l&&i.createElement($e,{opened:s},i.createElement(ae.a,{size:15}))),l&&i.createElement(He,{opened:s},t.menu&&t.menu.map(e=>i.createElement(He,{opened:s,key:e.name},i.createElement(Se,Ie({item:e},d))))));return l||u||(p=i.createElement(Oe,null,i.createElement(ve,Ie({item:t},r&&{handleToggle:c}),`${t.name} `))),p};De.defaultProps={item:Ce,sidebarToggle:null,collapseAll:!0},De.defaultProps={opened:!1,hasActive:!1};const Te={opened:!0},Me=e=>e.opened?"45deg":"0deg",ze=C.d.div`
  position: relative;
  width: 23px;
  height: 32px;
...
`;ze.defaultProps=Te;const Le=Object(O.b)("colors.sidebarBg"),Be=Object(O.b)("colors.sidebarPrimary"),Re=Object(O.b)("colors.sidebarText"),Fe=Object(O.b)("colors.primary"),Ne=Object(O.b)("colors.background"),_e=Object(O.b)("colors.text"),qe=C.d.span`
  content: "";
  display: block;
  position: absolute;
  width: 100%;
...
`;qe.defaultProps=Te;const We=Object(O.b)("radii"),Ue=C.d.button`
  cursor: pointer;
  z-index: 99;
  position: absolute;
  display: flex;
...
`;Ue.defaultProps=Te;Object.assign({},Te,{onClick:e=>null});const Ge=({opened:e,onClick:t})=>i.createElement(Ue,{opened:e,onClick:t},i.createElement(ze,{opened:e},i.createElement(qe,{opened:e}),i.createElement(qe,{opened:e}),i.createElement(qe,{opened:e})));function Ve(e){return e&&"object"===typeof e&&"default"in e?e.default:e}const Ke=Ve(o("./node_modules/lodash/fp/pipe.js")),Je=Ve(o("./node_modules/lodash/fp/omit.js")),Qe=Ve(o("./node_modules/array-sort/index.js")),Ze=Ve(o("./node_modules/lodash/fp/flattenDepth.js")),Ye=Ve(o("./node_modules/match-sorter/dist/match-sorter.esm.js")),Xe=o("./node_modules/ulid/dist/index.esm.js"),et=Object(O.b)("colors.sidebarBg"),tt=Object(O.b)("colors.sidebarText"),ot=Object(O.b)("colors.sidebarBorder"),nt=C.d.div`
  position: relative;
  width: 320px;
  min-width: 320px;
  min-height: 100vh;
...
`;var Ct=o("./node_modules/react-feather/dist/icons/edit-2.js"),Ot=o.n(Ct);const Pt=C.d.button`
  cursor: pointer;
  display: flex;
  align-items: center;
  outline: none;
...
`,Ht=Object(C.d)(Pt)`
  background: transparent;
`;var $t=o("./node_modules/react-dropdown-select/lib/index.js"),Dt=o.n($t);function Tt(){return(Tt=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var n in o)Object.prototype.hasOwnProperty.call(o,n)&&(e[n]=o[n])}return e}).apply(this,arguments)}const Mt=e=>{let{options:t,...o}=e;const[n,a]=Object(i.useState)([{id:1,href:"/",title:"Latest",label:"Latest"}]),s=C.d.div` > div { display: inline-block; width: 145px } label {margin-right: 5px}`;return r.a.createElement(s,null,r.a.createElement(i.Fragment,null,r.a.createElement("label",null,"Versions:"),r.a.createElement(Dt.a,Tt({valueField:"id",placeholder:"Documentation",color:E,options:t,values:n,onChange:e=>{if(e.length>0&&n!==e){let t=e[0].href,o="_self";a(e),"Latest"!==e[0].title&&(t=`http://atlas.apache.org/${e[0].href}`,o="_blank"),window.open(t,o)}}},o))))};Mt.propTypes={};var zt=Mt;const Lt=C.d.div`
	width: 220px;
	padding: 0;
	margin-right: 5px;
	float: right;
`,Bt=()=>{const{config:e}=Object(i.useContext)(u.d.context),{atlasVersions:t}=e;return r.a.createElement(Lt,null,r.a.createElement(zt,{options:t,style:{minHeight:"auto",padding:"0 5px",borderRadius:"5px"}}))},Rt=C.d.div`
  width: inherit;
  height: auto;
  padding: 0;
  position: fixed;
...
`,qt=Object(C.d)(Ht.withComponent("a"))`
  display: flex;
  align-items: center;
  justify-content: center;
  position: absolute;
...
`,go={a:({href:e,...t})=>{const{separator:o,linkComponent:n}=Object(u.g)(),a=Object(u.h)(),r=Object(i.useMemo)(()=>((e,t)=>"undefined"===typeof window?null:[location.pathname.split(e).slice(0,-1).join(e).slice(1),(t||"").replace(/^(?:\.\/)+/gi,"")].join("/"))(o,e),[o,e]),s=a&&a.find(e=>e.filepath===r),l=s?s.route:e;return l&&l.startsWith("/")?i.createElement(D,$({as:n},t,{to:l})):i.createElement(D,$({},t,{href:l}))},blockquote:P,inlineCode:H,loading:()=>i.createElement(T,null,i.createElement(R,null)),notFound:()=>i.createElement(At,null,i.createElement(wt,null),i.createElement(Et,null,i.createElement(jt,null,"Page Not Found"),i.createElement(St,null,"Check if you changed the document route or deleted it!"))),ol:It,p:Ut,page:({children:e,doc:{link:t,fullpage:o,edit:n=!1}})=>{const{repository:a}=Object(u.g)(),{props:r}=e,s=ye.pagesForGithubLink.toString().includes(r.doc.name),l=i.createElement(i.Fragment,null,t&&n&&i.createElement(qt,{href:t,target:"_blank"},i.createElement(Wt,{width:14})," Edit page"),i.createElement(Ft,{showGithubLink:s}),e);return i.createElement(At,null,a&&i.createElement(_,{repository:a}),!o&&i.createElement(wt,null),i.createElement(Nt,null,o?l:i.createElement(_t,null,l)))},pre:()=>i.createElement("div",null),props:({title:e,isRaw:t,isToggle:o,...n})=>{const[a,r]=Object(i.useState)(!0),s=Object(u.f)(),l=Object(i.useMemo)(()=>Object(C.d)(s.H3||"h3")`
      padding: 8px 0;
      position: relative;
      ${t?"":"margin-bottom: 0;"}
...
`,bo={colors:n,styles:{body:C.c`
  ...
  `,blockquote:C.c`
    ...
    font-style: italic;
    font-size: 16px;
  `},fonts:{display:'"Source Sans Pro", sans-serif',mono:'"Inconsolata", monospace',ui:'"Source Sans Pro", sans-serif'},radii:"2px",mode:"light",showPlaygroundEditor:!1,linesToScrollEditor:18},vo=(Object(O.b)("colors.sidebarBg"),Object(O.b)("colors.sidebarText","#13161F"),C.d.a`
  &,
  &:visited,
  &:active {
    text-decoration: none;
